...
class CoreSubscriptionsManager(
    ...
    private val _status: MutableStateFlow<SubscriptionsManager.Status> = MutableStateFlow(SubscriptionsManager.Status.None)
    override val status: Flow<SubscriptionsManager.Status>
        get() = _status
    ...
    override suspend fun updateStatus(status: SubscriptionsManager.Status) {
